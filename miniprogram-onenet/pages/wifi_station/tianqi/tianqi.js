...
const devicesId = "562202523" // 填写在OneNet上获得的devicesId 形式就是一串数字 例子:9939133
const api_key = "gj73vG5V9sVaGK3FFHXmAdaYElw=" // 填写在OneNet上的 api-key 例子: VeFI0HZ44Qn5dZO14AuLbWSlSlI=
...
hu:'',
  ...
  getDatapoints: function () {
    return new Promise((resolve, reject) => {
      wx.request({
        url: `https://api.heclouds.com/devices/${devicesId}/datapoints?datastream_id=Light,Temperature,Humidity&limit=9`,
        /**
         * 添加HTTP报文的请求头, 
        ...
        success: (res) => {
          ...
          this.setData({
            ri: response.data.datastreams[0].datapoints[0].at,
            te: response.data.datastreams[0].datapoints[0].value,
            li: response.data.datastreams[1].datapoints[0].value,
            hu: response.data.datastreams[2].datapoints[0].value,
          })
